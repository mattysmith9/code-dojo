            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="Your personal website or your company website"
                />
                <TextFieldGroup
                  ...
                  info="Current City or City & State "
                />
                <TextFieldGroup
                  placeholder="* Skills"
                  name="skills"
                  ...
                  onChange={this.onChange}
                  error={errors.skills}
                  info="Please use comma separated values (eg: HTML, CSS, JavaScript, Kotlin, Python"
                />
                <TextFieldGroup
